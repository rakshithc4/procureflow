...
// Deep space-navy → teal → sand recipe, tuned to sit behind the existing
// dark theme (background #0a0b10) instead of the shader builder's default.
const UNIFORMS = {
  colors: [
    [0.0392, 0.0431, 0.0627], // ~#0a0b10 (app background)
    [0, 0.1294, 0.1804], // deep teal
    [0.149, 0.298, 0.349], // muted teal-slate
    [0.2118, 0.251, 0.349], // indigo-slate (brand-adjacent)
    [0.2118, 0.251, 0.349],
    [0.2118, 0.251, 0.349],
    [0.2118, 0.251, 0.349],
    [0.2118, 0.251, 0.349],
